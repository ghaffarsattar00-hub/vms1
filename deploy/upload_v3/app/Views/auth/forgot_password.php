    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-2xl shadow-black/20 p-8 fade-up">
            <div class="mb-6 text-center">
                ...
                <p class="text-slate-500 mt-1.5 text-sm">Enter your email and we'll send you a reset link valid for 1 hour.</p>
            </div>

            <form method="POST" action="<?php echo BASE_URL; ?>forgot-password" class="space-y-4">
                <?php echo $csrfInput; ?>
            ...
            <div class="mt-5 text-center">
                <p class="text-sm text-slate-500">Remember it? <a href="<?php echo BASE_URL; ?>login" class="text-teal-600 font-semibold hover:text-teal-700 transition">Back to Sign In</a></p>
            </div>
        </div>

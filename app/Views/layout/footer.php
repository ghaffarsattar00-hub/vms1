...
function openModal(id) {
    ...
    if (m) { m.classList.remove('hidden'); m.classList.add('flex'); m.querySelector('.modal-panel') && (m.querySelector('.modal-panel').style.animation = 'fadeIn 0.2s ease-out forwards'); }
}

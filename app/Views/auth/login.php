    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-2xl shadow-black/20 p-8 fade-up">
            ...
            <div class="mt-6 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-3">Quick Access</p>
                <div class="grid grid-cols-3 gap-2">
                    <button type="button" onclick="fillLogin('admin@aku.edu.pk', 'password')" class="cursor-pointer group px-2 py-2.5 bg-white rounded-xl border border-slate-200 hover:border-teal-300 hover:shadow-md transition-all duration-200 text-left">
                        <p class="text-[11px] font-bold text-teal-600">Admin</p>
                        <p class="text-[10px] text-slate-400 mt-0.5 truncate">admin@aku.edu.pk</p>
                    </button>
                    <button type="button" onclick="fillLogin('ali.raza@gmail.com', 'password')" class="cursor-pointer group px-2 py-2.5 bg-white rounded-xl border border-slate-200 hover:border-emerald-300 hover:shadow-md transition-all duration-200 text-left">
                ...
                <div class="grid grid-cols-2 gap-2 mt-2">
                    <button type="button" onclick="fillLogin('info@aku.edu.pk', 'hospital123')" class="cursor-pointer group px-2 py-2.5 bg-white rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 text-left">
                        <p class="text-[11px] font-bold text-blue-600">Aga Khan</p>
                        <p class="text-[10px] text-slate-400 mt-0.5 truncate">info@aku.edu.pk</p>
                    </button>
                    <button type="button" onclick="fillLogin('info@jinnah.edu.pk', 'hospital123')" class="cursor-pointer group px-2 py-2.5 bg-white rounded-xl border border-slate-200 hover:border-purple-300 hover:shadow-md transition-all duration-200 text-left">
                        <p class="text-[11px] font-bold text-purple-600">Jinnah Hosp</p>
                        <p class="text-[10px] text-slate-400 mt-0.5 truncate">info@jinnah.edu.pk</p>
                    </button>
                </div>
                <p class="text-[10px] text-slate-400 mt-2.5 text-center">Admin/Parent: <code class="bg-slate-100 px-1.5 py-0.5 rounded font-mono text-slate-500">password</code> | Hospitals: <code class="bg-slate-100 px-1.5 py-0.5 rounded font-mono text-slate-500">hospital123</code></p>
            </div>
        </div>
    ...
    <div class="w-1/2 flex items-center justify-center bg-white p-12">
        <div class="w-full max-w-md fade-up">
            ...
            <div class="mt-8 p-5 bg-slate-50 rounded-2xl border border-slate-100">
                <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-3">Quick Access</p>
                <div class="grid grid-cols-3 gap-2">
                    <button type="button" onclick="fillLogin('admin@aku.edu.pk', 'password')" class="cursor-pointer group px-3 py-2.5 bg-white rounded-xl border border-slate-200 hover:border-teal-300 hover:shadow-md transition-all duration-200 text-left">
                        <p class="text-[11px] font-bold text-teal-600 group-hover:text-teal-700">Admin</p>
                        <p class="text-[10px] text-slate-400 mt-0.5 truncate">admin@aku.edu.pk</p>
                    </button>
                    <button type="button" onclick="fillLogin('ali.raza@gmail.com', 'password')" class="cursor-pointer group px-3 py-2.5 bg-white rounded-xl border border-slate-200 hover:border-emerald-300 hover:shadow-md transition-all duration-200 text-left">
                ...
                <div class="grid grid-cols-2 gap-2 mt-2">
                    <button type="button" onclick="fillLogin('info@aku.edu.pk', 'hospital123')" class="cursor-pointer group px-3 py-2.5 bg-white rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 text-left">
                        <p class="text-[11px] font-bold text-blue-600 group-hover:text-blue-700">Aga Khan</p>
                        <p class="text-[10px] text-slate-400 mt-0.5 truncate">info@aku.edu.pk</p>
                    </button>
                    <button type="button" onclick="fillLogin('info@jinnah.edu.pk', 'hospital123')" class="cursor-pointer group px-3 py-2.5 bg-white rounded-xl border border-slate-200 hover:border-purple-300 hover:shadow-md transition-all duration-200 text-left">
                        <p class="text-[11px] font-bold text-purple-600 group-hover:text-purple-700">Jinnah Hosp</p>
                        <p class="text-[10px] text-slate-400 mt-0.5 truncate">info@jinnah.edu.pk</p>
                    </button>
                </div>
                <p class="text-[10px] text-slate-400 mt-3 text-center">Admin/Parent: <code class="bg-slate-100 px-1.5 py-0.5 rounded font-mono text-slate-500">password</code> | Hospitals: <code class="bg-slate-100 px-1.5 py-0.5 rounded font-mono text-slate-500">hospital123</code></p>
            </div>
        </div>
    </div>
</div>
...
function fillLogin(email, password) {
    ...
    forms.forEach(function(form) {
        ...
        if (passInput) { passInput.value = pw; passInput.dispatchEvent(new Event('input')); }
    });
    var firstEmail = document.querySelector('input[name="email"]');
